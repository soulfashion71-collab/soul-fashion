        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-4 gap-4">
          ...
          <div className="flex items-center gap-5 text-sm font-medium">
            ...
            <button className="relative">
              Bag
              <span className="absolute -top-2 -right-3 bg-pink-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                {cartCount}
              </span>
            </button>
          </div>
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-pink-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:opacity-90"
                  >
                    Add
                  </button>
                </div>
